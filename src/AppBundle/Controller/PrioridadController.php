...
class PrioridadController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AppBundle:Prioridad')->findAll();
     ...
     * @Method("POST")
     * @Template("AppBundle:Prioridad:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AppBundle:Prioridad')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AppBundle:Prioridad:edit.html.twig")
     */
